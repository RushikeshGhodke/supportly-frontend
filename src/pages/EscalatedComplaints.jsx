...
const EscalatedComplaints = () => {
    ...
    // Filter complaints (Only Escalated)
    ...
    const downloadExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "Escalated Complaints");
        const excelBuffer = XLSX.write(workbook, { bookType: "xlsx", type: "array" });
        const data = new Blob([excelBuffer], { type: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" });
        saveAs(data, "escalated_complaints.xlsx");
    };

    // Function to Download as PDF
    const downloadPDF = () => {
        const doc = new jsPDF();
        doc.text("Escalated Complaints Report", 14, 10);
        ...
        doc.save("escalated_complaints.pdf");
    };
        ...
        <section className="w-full mt-16 flex justify-center items-start bg-gray-100">
            <div className="bg-white rounded-xl shadow-lg w-full p-10">
                ...
                <div className="flex justify-between items-center mb-7">
                    <h1 className="text-[#0061A1] text-2xl font-semibold">Escalated Complaints</h1>
                ...
                <div className="bg-gray-100 p-4 rounded-lg shadow">
                    <h2 className="text-xl font-semibold mb-4 flex items-center">
                        <IoIosStats className="mr-2 text-red-500" /> Escalated Complaints
                    </h2>

                    {currentComplaints.length === 0 ? (
                        <p className="text-gray-500">No escalated complaints found.</p>
                    ) : (
                        <>
